...
class InternationalCinemaBasicDetailController extends Controller
{
    ...
    function update(Request $request, $id)
    {
        ...
        if ($icBasicDetail) {
            ...
            $icBasicDetail['sales']                 =   $payload['sales'] ?? null;
            $icBasicDetail['instagram']             =   $payload['instagram'] ?? null;
            $icBasicDetail['twitter']               =   $payload['twitter'] ?? null;
            $icBasicDetail['facebook']              =   $payload['facebook'] ?? null;
            $icBasicDetail->save();
            return redirect()->route('ic-basic-detail.index')->with('success', 'Basic details updated successfully.!!');
        } else {
