                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline mb-4">
                        <div class="card-header">
                            <div class="card-title">International Cinema Basic Details</div>
                        </div>
                        <form action="{{ route('ic-basic-detail.update', $icBasicDetail->id) }}" method="POST">
                            @csrf @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('cinema_id') is-invalid @enderror"
                                            id="cinema_id" name="cinema_id" value="{{ $icBasicDetail->cinema_id }}"
                                            readonly />
                                        @error('cinema_id')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('director') is-invalid @enderror"
                                            ...
                                            value="{{ old('director', $icBasicDetail->director) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('producer') is-invalid @enderror"
                                            ...
                                            value="{{ old('producer', $icBasicDetail->producer) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('screenplay') is-invalid @enderror"
                                            ...
                                            value="{{ old('screenplay', $icBasicDetail->screenplay) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('cinematographer', $icBasicDetail->cinematographer) }}"
                                            placeholder="Enter cinematographer." />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('editor') is-invalid @enderror"
                                            ...
                                            value="{{ old('editor', $icBasicDetail->editor) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('cast') is-invalid @enderror"
                                            id="cast" name="cast" value="{{ old('cast', $icBasicDetail->cast) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('dop') is-invalid @enderror"
                                            id="dop" name="dop" value="{{ old('dop', $icBasicDetail->dop) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('other_details', $icBasicDetail->other_details) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('synopsis') is-invalid @enderror"
                                            ...
                                            value="{{ old('synopsis', $icBasicDetail->synopsis) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="director_bio" name="director_bio"
                                            value="{{ old('director_bio', $icBasicDetail->director_bio) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="producer_bio" name="producer_bio"
                                            value="{{ old('producer_bio', $icBasicDetail->producer_bio) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="sales_agent" name="sales_agent"
                                            value="{{ old('sales_agent', $icBasicDetail->sales_agent) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('award') is-invalid @enderror"
                                            id="award" name="award"
                                            value="{{ old('award', $icBasicDetail->award) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('writer') is-invalid @enderror"
                                            ...
                                            value="{{ old('writer', $icBasicDetail->writer) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="trailer_link" name="trailer_link"
                                            value="{{ old('trailer_link', $icBasicDetail->trailer_link) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('official_selection', $icBasicDetail->official_selection) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('best_film_award', $icBasicDetail->best_film_award) }}"
                                            placeholder="Enter best film award." />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('director_and_producer', $icBasicDetail->director_and_producer) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('original_title', $icBasicDetail->original_title) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="co_produced" name="co_produced"
                                            value="{{ old('co_produced', $icBasicDetail->co_produced) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="festivals" value="{{ old('festivals', $icBasicDetail->festivals) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('drama') is-invalid @enderror"
                                            id="drama" name="drama"
                                            value="{{ old('drama', $icBasicDetail->drama) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('history') is-invalid @enderror"
                                            ...
                                            value="{{ old('history', $icBasicDetail->history) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nomination', $icBasicDetail->nomination) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="premiere" name="premiere" value="{{ old('nomination', $icBasicDetail->premiere) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="festival_history" name="festival_history" value="{{ old('festival_history', $icBasicDetail->festival_history) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="link_trailer" name="link_trailer" value="{{ old('link_trailer', $icBasicDetail->link_trailer) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="tags" name="tags" value="{{ old('tags',$icBasicDetail->tags) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="sales" name="sales" value="{{ old('sales', $icBasicDetail->sales) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="instagram" name="instagram" value="{{ old('instagram',$icBasicDetail->instagram) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="twitter" name="twitter" value="{{ old('twitter', $icBasicDetail->twitter) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="facebook" name="facebook" value="{{ old('facebook',$icBasicDetail->facebook) }}"
