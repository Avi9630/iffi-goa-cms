...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <span>
                <h4 class="alert-danger"> Update Highlight</h4>
            </span>
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline mb-4">
                        <div class="card-header">
                            <div class="card-title">Highlight Form</div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if ($highlight->img_url)
                                            <img src="{{ $highlight->img_url }}" alt="Current Image" class="img-fluid mt-2"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('image_url') is-invalid @enderror"
                                            ...
                                            value="{{ old('image_url', $highlight->img_url) }}">
                                        @error('image_url')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
